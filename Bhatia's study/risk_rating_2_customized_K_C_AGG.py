...
max_min_results2 = results_df_2.groupby('model').agg({'mean_score_R2': ['max', 'min'], 'mean_score_RMSE': ['max', 'min']})
# results_df_2.to_excel('/Users/ClaudioProiettiMercuri_1/Downloads/results_df_2.xlsx')
max_min_results2.to_excel('/Users/ClaudioProiettiMercuri_1/Downloads/MAXmin_df_2.xlsx')
