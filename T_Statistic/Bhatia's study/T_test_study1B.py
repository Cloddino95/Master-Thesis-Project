...
from risk_rating_1B_customized_K_C_AGG import X, y
...
paired_sample_ttest_1B = pd.DataFrame(
    {'model': ['SVR-RBF', 'SVR-polynomial', 'SVR-sigmoid', 'Lasso Regression', 'Ridge Regression', 'KNN Regression'],
...
# paired_sample_ttest_1B.to_csv('paired_sample_Ttest_NOcorrection_1B.csv')

# applying Bonferroni correction on the above paired sample t-test results df

Bonfcorrect_Ttest_1b = paired_sample_ttest_1B.copy()

# columns to be multiplied
cols_to_multiply = ['p_value_R2', 'p_value_MSE']
# apply multiplication
for col in cols_to_multiply:
    Bonfcorrect_Ttest_1b[col] = Bonfcorrect_Ttest_1b[col] * 3

# Bonfcorrect_Ttest_1b.to_csv('paired_sample_Ttest_Bonfcorrection_1B.csv')
