...
from combined_risk_rating_2 import X2, y2
...
paired_sample_ttest_2_comb = pd.DataFrame(
    {'model': ['SVR-RBF', 'SVR-polynomial', 'SVR-sigmoid', 'Lasso Regression', 'Ridge Regression', 'KNN Regression'],
...
# paired_sample_ttest_2_comb.to_csv('paired_sample_Ttest_NOcorrection_COMBINED_2.csv')

# applying Bonferroni correction on the above paired sample t-test results df

Bonfcorrect_Ttest_2_comb = paired_sample_ttest_2_comb.copy()

# columns to be multiplied
cols_to_multiply = ['p_value_R2', 'p_value_MSE']
# apply multiplication
for col in cols_to_multiply:
    Bonfcorrect_Ttest_2_comb[col] = Bonfcorrect_Ttest_2_comb[col] * 3

# Bonfcorrect_Ttest_2_comb.to_csv('paired_sample_Ttest_Bonfcorrection_COMBINED_2.csv')
