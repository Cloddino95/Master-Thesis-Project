...
X_main = data_300dim_2.drop('mean_ratings', axis=1)
y_main = data_300dim_2['mean_ratings']
...
"""I got the same results for both one-sample and paired t-test. Of course, but I wanted to double-check being new in th field.
I will use the results from paired t-test."""
...
paired_sample_ttest_2 = pd.DataFrame(
    {'model': ['SVR-RBF', 'SVR-polynomial', 'SVR-sigmoid', 'Lasso Regression', 'Ridge Regression', 'KNN Regression'],
...
paired_sample_ttest_2.to_csv('paired_sample_Ttest_NOcorrection_2.csv')

# applying Bonferroni correction on the above paired sample t-test results df

Bonfcorrect_Ttest_2 = paired_sample_ttest_2.copy()

# columns to be multiplied
cols_to_multiply = ['p_value_R2', 'p_value_MSE']
# apply multiplication
for col in cols_to_multiply:
    Bonfcorrect_Ttest_2[col] = Bonfcorrect_Ttest_2[col] * 3

# Bonfcorrect_Ttest_2.to_csv('paired_sample_Ttest_Bonfcorrection_2.csv')
