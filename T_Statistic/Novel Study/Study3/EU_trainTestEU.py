...
from Europe_Perception_TrainTestEU import X, y
...
metrics_EU = pd.DataFrame(metrics_list)
prediction_EU = pd.DataFrame(prediction_list)

# ------------------------------------------------- difference 1close & psy --------------------------------------------

diffR2_RBF_psy = metrics_EU[metrics_EU['Model'] == 'SVR-RBF']['R2_1close'] - metrics_psy[metrics_psy['Model'] == 'SVR-RBF']['R2_psy']
diffRMSE_RBF_psy = metrics_EU[metrics_EU['Model'] == 'SVR-RBF']['RMSE_1close'] - metrics_psy[metrics_psy['Model'] == 'SVR-RBF']['RMSE_psy']

diffR2_Ridge_psy = metrics_EU[metrics_EU['Model'] == 'Ridge Regression']['R2_1close'] - metrics_psy[metrics_psy['Model'] == 'Ridge Regression']['R2_psy']
diffRMSE_Ridge_psy = metrics_EU[metrics_EU['Model'] == 'Ridge Regression']['RMSE_1close'] - metrics_psy[metrics_psy['Model'] == 'Ridge Regression']['RMSE_psy']
...
RBF_psy_t2_statistic_r2, RBF_psy_p2_value_r2 = stats.ttest_rel(metrics_EU[metrics_EU['Model'] == 'SVR-RBF']['R2_1close'], metrics_psy[metrics_psy['Model'] == 'SVR-RBF']['R2_psy'])
RBF_psy_t2_statistic_rmse, RBF_psy_p2_value_rmse = stats.ttest_rel(metrics_EU[metrics_EU['Model'] == 'SVR-RBF']['RMSE_1close'], metrics_psy[metrics_psy['Model'] == 'SVR-RBF']['RMSE_psy'])
Ridge_psy_t2_statistic_r2, Ridge_psy_p2_value_r2 = stats.ttest_rel(metrics_EU[metrics_EU['Model'] == 'Ridge Regression']['R2_1close'], metrics_psy[metrics_psy['Model'] == 'Ridge Regression']['R2_psy'])
Ridge_psy_t2_statistic_rmse, Ridge_psy_p2_value_rmse = stats.ttest_rel(metrics_EU[metrics_EU['Model'] == 'Ridge Regression']['RMSE_1close'], metrics_psy[metrics_psy['Model'] == 'Ridge Regression']['RMSE_psy'])

# save the results of the paired sample t-tests in a dataframe
t_test_EU = pd.DataFrame({
    'model': ['SVR-RBF', 'Ridge Regression'],
...
Bonfcorrect_Ttest_EU = t_test_EU.copy()

# columns to be multiplied
cols_to_multiply = ['p_value_R2', 'p_value_RMSE']
# apply multiplication
for col in cols_to_multiply:
    Bonfcorrect_Ttest_EU[col] = Bonfcorrect_Ttest_EU[col] * 3
