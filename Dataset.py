...
# TODO: EACH VALUE IN THE DATAFRAME IS AN OBJECT, I NEED TO CONVERT THEM TO FLOATS

"""all the below dataset have been previously cleaned in R the code and the file are in the *data* folder located in "Datenmodell Bhatia" folder """
